This app shows list of images(arranged properly on DOM) based on the users input. API requests are made to unsplash (https://unsplash.com/) API to get records based on searched term. New concepts learned :
